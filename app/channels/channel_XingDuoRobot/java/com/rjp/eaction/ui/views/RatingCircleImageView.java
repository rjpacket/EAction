...
public class RatingCircleImageView extends AppCompatImageView {
    ...
    public RatingCircleImageView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
...
//        super.onDraw(canvas);
        ...
        if(drawable != null) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                canvas.drawArc(AppUtils.dp2px(1), AppUtils.dp2px(1), width - AppUtils.dp2px(1), height - AppUtils.dp2px(1), -90, 360 * rating, false, whitePaint);
            }
        }
    }
