...
public class EActionRefreshHeader extends LinearLayout implements RefreshHeader {
    ...
    public EActionRefreshHeader(Context context) {
        this(context, null);
    }

    public EActionRefreshHeader(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }

    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.header_eaction_header_view, this);
