...
public class ReadTimeListView extends LoadMoreListView<String> {
    public ReadTimeListView(Context context) {
        super(context);
    }

    public ReadTimeListView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected BaseAdapter getListAdapter() {
        ...
        mDatas.add("");
        mDatas.add("");
        return new CommonAdapter<String>(mContext, R.layout.item_read_time_list_view, mDatas) {
            @Override
